...
export async function getServerSideProps(context) {
  const postsQuery = query(
    ...
    where("tags", "array-contains", "Documentation"),
    limit(LIMIT)
  );
        ...
        >
          <div className="card-content">
            ...
            <p className="card-text">
              Comprehensive guides and reference materials that document the
              functionality, usage, and technical details of projects and
              technologies.
            </p>
          </div>
        </div>
