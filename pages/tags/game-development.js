...
export async function getServerSideProps(context) {
  const postsQuery = query(
    ...
    where("tags", "array-contains", "Game Development"),
    limit(LIMIT)
  );
...
export default function GameDevelopmentPage(props) {
        ...
        >
          <div className="card-content">
            ...
            <p className="card-text">
              Projects and resources focused on the creation and development of
              video games. Includes game design, coding, graphics, and sound,
              covering both development and deployment.
            </p>
          </div>
        </div>
