...
export async function getServerSideProps(context) {
  const postsQuery = query(
    ...
    where("tags", "array-contains", "DevOps"),
    limit(LIMIT)
  );
...
export default function DevOpsPage(props) {
        ...
        >
          <div className="card-content">
            ...
            <p className="card-text">
              Projects and resources related to the practices of DevOps,
              including continuous integration, continuous delivery (CI/CD), and
              infrastructure as code. Aimed at improving collaboration and
