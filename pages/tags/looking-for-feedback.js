...
export async function getServerSideProps(context) {
  const postsQuery = query(
    ...
    where("tags", "array-contains", "Looking for Feedback"),
    limit(LIMIT)
  );
        ...
        >
          <div className="card-content">
            ...
            <p className="card-text">
              Projects where the creators are seeking constructive feedback from
              the community to improve their work. An opportunity to give and
