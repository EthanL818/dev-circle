...
export async function getServerSideProps(context) {
  const postsQuery = query(
    ...
    where("tags", "array-contains", "Mobile Development"),
    limit(LIMIT)
  );
...
export default function MobileDevelopmentPage(props) {
        ...
        >
          <div className="card-content">
            ...
            <p className="card-text">
              Projects and resources for developing mobile applications for
              platforms such as Android and iOS. Covers native development,
              cross-platform development, and mobile UI/UX design.
            </p>
          </div>
        </div>
