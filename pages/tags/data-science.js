...
export async function getServerSideProps(context) {
  const postsQuery = query(
    ...
    where("tags", "array-contains", "Data Science"),
    limit(LIMIT)
  );
        ...
        >
          <div className="card-content">
            ...
            <p className="card-text">
              Projects and resources dedicated to data analysis, visualization,
              and interpretation. Involves using statistical and computational
