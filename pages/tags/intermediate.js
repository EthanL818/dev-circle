...
export async function getServerSideProps(context) {
  const postsQuery = query(
    ...
    where("tags", "array-contains", "Intermediate"),
    limit(LIMIT)
  );
...
export default function IntermediatePage(props) {
        ...
        >
          <div className="card-content">
            ...
            <p className="card-text">
              Projects and resources aimed at developers with a moderate level
              of experience. Suitable for those who have mastered the basics and
              are ready to tackle more complex challenges.
            </p>
          </div>
        </div>
