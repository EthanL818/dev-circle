...
export async function getServerSideProps(context) {
  const postsQuery = query(
    ...
    where("tags", "array-contains", "Cloud Computing"),
    limit(LIMIT)
  );
...
export default function CloudComputingPage(props) {
        ...
        >
          <div className="card-content">
            ...
            <p className="card-text">
              Projects and resources focused on cloud services and
              infrastructure. Includes topics like cloud storage, cloud
              computing platforms (AWS, Azure, GCP), and cloud-native
