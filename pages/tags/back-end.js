...
export async function getServerSideProps(context) {
  const postsQuery = query(
    ...
    where("tags", "array-contains", "Back-end"),
    limit(LIMIT)
  );
...
export default function BackEndPage(props) {
        ...
        >
          <div className="card-content">
            ...
            <p className="card-text">
              Projects focused on server-side development, including database
              management, server logic, and integration. Involves languages and
